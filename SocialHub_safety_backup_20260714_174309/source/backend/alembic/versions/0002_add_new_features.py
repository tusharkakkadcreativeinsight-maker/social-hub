...
def safe_create_index(index_name, table_name, columns, unique=False):
    ...
    Some local SQLite databases were previously bootstrapped with
    `Base.metadata.create_all()` before Alembic version rows were stamped. When
    Alembic later replays this migration, tables or indexes may already exist.
    Skipping duplicate indexes preserves data and makes `alembic upgrade head`
    safe on those existing development databases.
    """
    try:
...
def upgrade():
    ...
    safe_create_index('idx_verification_status', 'verification_requests', ['status'], unique=False)
    ...
    safe_create_index('idx_saved_collection_user', 'saved_collections', ['user_id'], unique=False)
    ...
    safe_create_index('idx_collection_item_collection', 'collection_items', ['collection_id'], unique=False)
    ...
    safe_create_index('idx_profile_visit_visited', 'profile_visits', ['visited_user_id', 'created_at'], unique=False)
    safe_create_index('idx_profile_visit_visitor', 'profile_visits', ['visitor_id', 'created_at'], unique=False)
    ...
    safe_create_index('idx_creator_wallet_user', 'creator_wallets', ['user_id'], unique=True)
    ...
    safe_create_index('idx_earning_user', 'earning_records', ['user_id', 'created_at'], unique=False)
    ...
    safe_create_index('idx_payout_user', 'payout_requests', ['user_id', 'created_at'], unique=False)
    ...
    safe_create_index('idx_recent_search_user', 'recent_searches', ['user_id', 'created_at'], unique=False)
    ...
    safe_create_index('idx_hashtag_trend_score', 'hashtag_trends', ['hashtag', 'trend_score'], unique=False)
    ...
    safe_create_index('idx_user_online_status_user', 'user_online_status', ['user_id'], unique=True)
    ...
    safe_create_index('idx_deleted_message_user', 'deleted_messages', ['user_id'], unique=False)
