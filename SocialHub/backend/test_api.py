...
def api_test(name, method, url, data=None, headers=None, expected_status=None, files=None, allowed_statuses=None, form=None):
...
# ==================== Health Check ====================
api_test("Health Check", "GET", "/api/health", expected_status=200)
...
api_test("Duplicate Register (should fail)", "POST", "/api/auth/register",
     data={"email": TEST_EMAIL, "username": TEST_USERNAME, "password": TEST_PASSWORD},
     expected_status=400)

# ==================== Auth Me ====================
api_test("Get Current User", "GET", "/api/auth/me", headers=auth_headers, expected_status=200)

# ==================== User Profile ====================
api_test("Get User Profile", "GET", "/api/users/profile/testuser", headers=auth_headers, expected_status=200)
api_test("Update Profile", "PUT", "/api/users/profile",
     data={"full_name": "Updated Name", "bio": "Hello World", "location": "New York"},
     headers=auth_headers, expected_status=200)
api_test("Get User by ID", "GET", f"/api/users/by-username/testuser", headers=auth_headers, expected_status=200)
...
if user2_id:
    api_test("Follow User", "POST", f"/api/follow/{user2_id}", headers=auth_headers, expected_status=200, allowed_statuses=[400])
    api_test("Check Follow Status", "GET", f"/api/follow/check/{user2_id}", headers=auth_headers, expected_status=200)
    api_test("Get Followers", "GET", f"/api/follow/followers/{user2_id}", headers=auth_headers, expected_status=200)
    api_test("Get Following", "GET", f"/api/follow/following/{user2_id}", headers=auth_headers, expected_status=200)
else:
    results.append(("Follow User", "SKIP", "No user2_id"))

# ==================== Posts ====================
api_test("Create Post", "POST", "/api/posts",
     data={"content": "Hello, this is a test post!", "hashtags": "test,social"},
     headers=auth_headers, expected_status=201)
api_test("Get Feed", "GET", "/api/posts?page=1&page_size=10", headers=auth_headers, expected_status=200)
...
if post_id:
    api_test("Get Single Post", "GET", f"/api/posts/{post_id}", headers=auth_headers, expected_status=200)
    api_test("Update Post", "PUT", f"/api/posts/{post_id}",
         data={"content": "Updated post content"}, headers=auth_headers, expected_status=200)

# ==================== Comments ====================
if post_id:
    api_test("Create Comment", "POST", f"/api/comments/{post_id}",
         data={"content": "Nice post!"}, headers=auth_headers, expected_status=201)
    api_test("Get Comments", "GET", f"/api/comments/{post_id}", headers=auth_headers, expected_status=200)
else:
    results.append(("Create Comment", "SKIP", "No post found"))

# ==================== Likes ====================
if post_id:
    api_test("Like Post", "POST", f"/api/likes/{post_id}",
         data={"reaction": "like"}, headers=auth_headers, expected_status=200)
    api_test("Get Post Likes", "GET", f"/api/likes/{post_id}", headers=auth_headers, expected_status=200)
    api_test("Unlike Post", "DELETE", f"/api/likes/{post_id}", headers=auth_headers, expected_status=200)
else:
    results.append(("Like Post", "SKIP", "No post found"))

# ==================== Stories ====================
api_test("Get Stories", "GET", "/api/stories", headers=auth_headers, expected_status=200)

# ==================== Reels ====================
api_test("Get Reels", "GET", "/api/reels?page=1&page_size=10", headers=auth_headers, expected_status=200)

# ==================== Messaging ====================
api_test("Create Chat", "POST", "/api/chats",
...
if chat_id:
    api_test("Get Chat by ID", "GET", f"/api/chats/{chat_id}", headers=auth_headers, expected_status=200)
    api_test("Get Chat Messages", "GET", f"/api/chats/{chat_id}/messages", headers=auth_headers, expected_status=200)
    api_test("Send Message", "POST", f"/api/chats/{chat_id}/messages",
         data={"content": "Hello!"}, headers=auth_headers, expected_status=200)

# ==================== Notifications ====================
api_test("Get Notifications", "GET", "/api/notifications", headers=auth_headers, expected_status=200)
api_test("Get Unread Count", "GET", "/api/notifications/unread-count", headers=auth_headers, expected_status=200)

# ==================== Search ====================
api_test("Search All", "GET", "/api/search?q=test&type=all", headers=auth_headers, expected_status=200)
api_test("Search Users", "GET", "/api/search/users?q=test", headers=auth_headers, expected_status=200)
api_test("Search Hashtags", "GET", "/api/search/hashtags?q=test", headers=auth_headers, expected_status=200)

# ==================== Advanced / Creator Features ====================
api_test("AI Caption Fallback", "POST", "/api/ai/caption",
     data={"title": "Summer launch", "description": "Behind the scenes", "category": "creator"},
     headers=auth_headers, expected_status=200)

api_test("Creator Dashboard", "GET", "/api/creator/dashboard", headers=auth_headers, expected_status=200)
...
if r_schedule is not None and r_schedule.status_code == 201:
    ...
    scheduled_id = None
api_test("List Scheduled Posts", "GET", "/api/schedule/me", headers=auth_headers, expected_status=200)
if scheduled_id:
    api_test("Delete Scheduled Post", "DELETE", f"/api/schedule/{scheduled_id}", headers=auth_headers, expected_status=200)

api_test("Reject Invalid Scheduled Content Type", "POST", "/api/schedule/post",
     data={"content": "Invalid schedule", "scheduled_at": future_time, "content_type": "invalid"},
     headers=auth_headers, expected_status=400)

api_test("Create Marketplace Product", "POST", "/api/marketplace/products",
     form={"title": "API Test Product", "description": "Created by test_api.py", "price": "19.99", "category": "Testing"},
     headers=auth_headers, expected_status=201)
api_test("List Marketplace Products", "GET", "/api/marketplace/products", expected_status=200)
...
if product_id:
    api_test("Get Marketplace Product", "GET", f"/api/marketplace/products/{product_id}", expected_status=200)
    api_test("Delete Own Marketplace Product", "DELETE", f"/api/marketplace/products/{product_id}", headers=auth_headers, expected_status=200, allowed_statuses=[404])
...
if r_collab is not None and r_collab.status_code == 201:
    ...
    offer_id = None
api_test("List Collaboration Offers", "GET", "/api/collabs", expected_status=200)
if offer_id and token2:
    api_test("Apply To Collaboration Offer", "POST", f"/api/collabs/{offer_id}/apply",
...
if user2_id:
    ...
    if r_group is not None and r_group.status_code == 201:
        ...
        group_id = None
    api_test("List Group Chats", "GET", "/api/chat/groups", headers=auth_headers, expected_status=200)
    if group_id:
        api_test("Send Group Message", "POST", f"/api/chat/groups/{group_id}/messages",
...
# ==================== Reports ====================
api_test("Create Report", "POST", "/api/reports",
     data={"reason": "spam", "description": "Test report"},
     headers=auth_headers, expected_status=201)

# ==================== Admin ====================
api_test("Admin Dashboard", "GET", "/api/admin/dashboard", headers=admin_headers, expected_status=200)
api_test("Admin Get Users", "GET", "/api/admin/users", headers=admin_headers, expected_status=200)
api_test("Admin Get Posts", "GET", "/api/admin/posts", headers=admin_headers, expected_status=200)
api_test("Admin Get Reports", "GET", "/api/admin/reports", headers=admin_headers, expected_status=200)
api_test("Admin Analytics", "GET", "/api/admin/analytics?days=7", headers=admin_headers, expected_status=200)
api_test("Non-Admin Dashboard (should fail)", "GET", "/api/admin/dashboard", headers=auth_headers, expected_status=403)

# ==================== Frontend Pages ====================
api_test("Frontend Index", "GET", "/", expected_status=200)
api_test("Frontend Login", "GET", "/login", expected_status=200)
api_test("Frontend Register", "GET", "/register", expected_status=200)
api_test("Frontend Posts", "GET", "/posts", expected_status=200)
api_test("Frontend Chat", "GET", "/chat", expected_status=200)
api_test("Frontend Stories", "GET", "/stories", expected_status=200)
api_test("Frontend Reels", "GET", "/reels", expected_status=200)
api_test("Frontend Notifications", "GET", "/notifications", expected_status=200)
api_test("Frontend Search", "GET", "/search", expected_status=200)
api_test("Frontend Admin", "GET", "/admin", expected_status=200)
api_test("Frontend Profile", "GET", "/profile/testuser", expected_status=200)
api_test("Frontend Forgot Password", "GET", "/forgot-password", expected_status=200)
api_test("Frontend Reset Password", "GET", "/reset-password", expected_status=200)
api_test("Frontend Creator Dashboard", "GET", "/creator-dashboard", expected_status=200)
api_test("Frontend Scheduled", "GET", "/scheduled", expected_status=200)
api_test("Frontend Marketplace", "GET", "/marketplace", expected_status=200)
api_test("Frontend Collabs", "GET", "/collabs", expected_status=200)
